...
class Agent(dbus.service.Object):
    ...
    def AuthorizeService(self, device, uuid):
        print("Allowed Devices : %s" % (MAC_ADDRESS))
        print("AuthorizeService (%s, %s)" % (device, uuid))
        if uuid == "0000110d-0000-1000-8000-00805f9b34fb" and device in DEVICES:
            print("Authorized A2DP Service")
            return
        print("Rejecting non-A2DP Service or non-MAC Allowed Address")
