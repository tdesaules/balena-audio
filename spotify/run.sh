...
do
    # start spotify
    librespot --name $STREAM --backend pipe --device /var/cache/snapcast/$STREAM --cache /var/cache/spotify --bitrate 320 --device-type speaker --enable-volume-normalisation --initial-volume 50 &
done
